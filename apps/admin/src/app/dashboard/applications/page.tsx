...
import { cn, formatDate, formatDateTime, getInitials, getRelativeTime } from "@/lib/utils";
...
const mockApplications = [
  {
    ...
    properties: [
      { name: "Sunny View Boarding House", address: "123 Main St, Manila", rooms: 10 },
      { name: "Green Residence", address: "456 Oak Ave, Quezon City", rooms: 8 },
  ...
  },
  {
    ...
    properties: [
      ...
      { name: "Cozy Corner BH", address: "987 Cedar Ln, Mandaluyong", rooms: 6 },
    ],
  ...
  },
  {
    ...
    reviewedBy: "Admin User",
    notes: "Invalid documents submitted. ID appears to be expired and property ownership documents do not match.",
  },
];
...
export default function ApplicationsPage() {
  ...
  const confirmReview = () => {
    ...
    console.log(`${reviewAction} application ${selectedApplication?.id} with notes: ${reviewNotes}`);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Landlord Applications</h1>
            ...
            <Card key={application.id} className="overflow-hidden">
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge className={cn("text-xs", statusColors[application.status as ApplicationStatus])}>
                            {application.status}
                          </Badge>
                        </div>
                        <p className="text-sm text-muted-foreground">
                        ...
                        <div className="mt-2 flex flex-wrap gap-4 text-sm">
                          <span className="flex items-center gap-1 text-muted-foreground">
                            ...
                            {application.properties.length} {application.properties.length === 1 ? "property" : "properties"}
                          </span>
                          <span className="flex items-center gap-1 text-muted-foreground">
                  ...
                  {/* Actions */}
                  <div className="flex items-center gap-2 border-t p-4 md:border-l md:border-t-0 md:p-6">
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <div>
                  ...
                  <div className="grid gap-4 rounded-lg border p-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <Badge className={cn(statusColors[selectedApplication.status as ApplicationStatus])}>
                ...
                <div>
                  ...
                  <div className="grid gap-4 rounded-lg border p-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedApplication.businessInfo.businessType}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Years of Experience</p>
                      <p className="font-medium">{selectedApplication.businessInfo.yearsExperience} years</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Number of Properties</p>
                      <p className="font-medium">{selectedApplication.businessInfo.numberOfProperties}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {selectedApplication.documents.map((doc, idx) => (
                      ...
                      >
                        <span>{doc.name}</span>
                        <Badge className={cn("text-xs", documentStatusColors[doc.status])}>
                          {doc.status}
                        </Badge>
                      </div>
                    ))}
