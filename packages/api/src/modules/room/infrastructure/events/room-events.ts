...
export class RoomUpdatedEvent extends DomainEvent<{ roomId: string; changes: string[] }> {
  constructor(
...
export class RoomStatusChangedEvent extends DomainEvent<{ roomId: string; oldStatus: string; newStatus: string }> {
  constructor(
    public readonly roomId: string,
