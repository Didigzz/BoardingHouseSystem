...
export const createPaymentRouter = (protectedProcedure: Procedure) => {
  return createTRPCRouter({
    ...
    create: protectedProcedure
      ...
      .mutation(
        async ({ ctx, input }: AuthenticatedCtx<CreatePaymentInput>) => {
    ...
    update: protectedProcedure
      ...
      .mutation(
        async ({ ctx, input }: AuthenticatedCtx<UpdatePaymentInput>) => {
          const { id, ...data } = input;
    ...
    delete: protectedProcedure
      ...
      .mutation(
        async ({ ctx, input }: AuthenticatedCtx<DeletePaymentInput>) => {
    ...
    getMonthlyRevenue: protectedProcedure
      ...
      .query(
        async ({
          ctx,
          input,
        }: AuthenticatedCtx<GetMonthlyRevenueInput | undefined>) => {
