...
export const createUserRouter = (
  protectedProcedure: ReturnType<typeof createTRPCRouter>
) => {
  return createTRPCRouter({
    login: publicProcedure
      .input(loginSchema)
      .mutation(
        async ({ ctx, input }: { ctx: TRPCContext; input: LoginInput }) => {
    ...
    register: publicProcedure
      ...
      .mutation(
        async ({ ctx, input }: { ctx: TRPCContext; input: RegisterInput }) => {
